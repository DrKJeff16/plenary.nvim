...
local function prof_cb(th, samples, vmmode)
  ...
  -- Order keys.
  local k1, k2
  if prof_split == 1 and key_state then
    k1 = key_state
    k2 = key_stack and key_stack or k2
  elseif key_stack then
    k1 = key_stack
    k2 = key_stack2 and key_stack2 or key_state
  end
...
local function prof_start(mode)
  ...
  local scope, flags = m.l or m.f or m.F or (prof_states and "" or "f"), (m.p or "")
  prof_raw = m.r
  if m.s then
    prof_split = 2
